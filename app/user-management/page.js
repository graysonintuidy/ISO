            ...
            <div className={styles.formGrid}>
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  className={`input ${errors.first_name ? styles.inputError : ''}`}
                  type="text"
                  placeholder="John"
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  id="create-last-name"
                  className={`input ${errors.last_name ? styles.inputError : ''}`}
                  type="text"
                  placeholder="Smith"
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  type="email"
                  placeholder="john.smith@nationalbeef.com"
                  value={form.email}
                ...
                {form.password && (
                  <div className={styles.strengthBar}>
                    <div className={styles.strengthTrack}>
                      <div
                        className={`${styles.strengthFill} ${pwStrength.className}`}
              ...
              <div className={styles.formGroup}>
                ...
                <select
                  id="create-role"
                  className={`input select ${errors.role_id ? styles.inputError : ''}`}
                  value={form.role_id}
