...
export default function SettingsPage() {
  ...
  const getTabDescription = () => {
    switch (activeTab) {
      case 'general':
        return 'Facility configuration and system preferences';
      case 'users':
        return 'Manage platform users and access';
      case 'roles':
        return 'Define roles and manage permission sets';
      default:
        return '';
    }
  };
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.pageHeader}>
        <div>
          <h1 className={styles.pageTitle}>Settings</h1>
          <p className={styles.pageSubtitle}>{getTabDescription()}</p>
        </div>
      </div>
